/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 763fc9afb2e8523d64bc3e4a38eb4289)
// Runtime types generated with workerd@1.20260430.1 2026-05-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DatabaseDO" | "ServerDO";
	}
	interface Env {
		ADMIN_API_TOKEN: string;
		DatabaseDO: DurableObjectNamespace<import("./src/index").DatabaseDO>;
		ServerDO: DurableObjectNamespace<import("./src/index").ServerDO>;
	}
}
